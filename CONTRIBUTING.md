# Contributing to Tempo AI MCP Server

Thank you for taking the time to contribute! This project uses **Python 3.13** and manages its dependencies with [uv](https://github.com/astral-sh/uv). The following guide summarizes how to set up your environment and outlines the workflow we expect for pull requests.
