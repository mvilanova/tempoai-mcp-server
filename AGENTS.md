...
This project is a Python 3.13 backend service built with FastMCP and httpx. All source code lives under `src/tempoai_mcp_server` and tests live under `tests`.
...
- When editing or running the server manually use `mcp run src/tempoai_mcp_server/server.py`.
